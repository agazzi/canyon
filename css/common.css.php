...
#goto_pagetop .icon.ic_s_top {
    width: 22px;
    height: 22px;
    background-position: 0 0 !important;
    background-image: url('./themes/canyon/img/navigation/ic_s_top.png') !important;
...
.switch_button.console_switch {
    position: fixed;
    top:12px;
    margin-<?php echo $left; ?>: 70px;

    background: url('./themes/canyon/img/navigation/console_switch.png') no-repeat #fff 2px 0 !important;
...
.buttonlinks a:hover,
a.button:hover {
    <?php echo $theme->getCssGradient('cccccc', 'dddddd'); ?>
}
...
#maincontainer #main_pane_left .group,
#maincontainer #main_pane_right .group {
    background-color: #fff;
...
#maincontainer #main_pane_left .group input,
#maincontainer #main_pane_right .group input,
#maincontainer #main_pane_left .group select,
#maincontainer #main_pane_right .group select {
    width: 100%;
}

#maincontainer #main_pane_left .group h2,
#maincontainer #main_pane_right .group h2 {
    background-color: transparent;
    text-shadow: none;
    box-shadow: none;
    color: #37474f;
...
#main_pane_left #li_change_password {
    margin-bottom: 30px !important;
}

#main_pane_left #li_change_password a {
...
#main_pane_left #li_change_password a img.ic_s_passwd {
    background-position: 0 0 !important;
    background-image: url('./themes/canyon/img/navigation/ic_s_passwd.png') !important;
...
input[type=number] {
    ...
    appearance: none;
    border-radius: 0px;
    background: url('./themes/canyon/img/navigation/ic_dropdown.png') no-repeat right 10px top 12px !important;
...
#maincontainer #main_pane_right .group ul {
    list-style-image: url('./themes/canyon/img/navigation/ic_dot.png');
}

#maincontainer #main_pane_left .group ul li form label img,
#maincontainer #main_pane_left .group #li_select_lang img,
#maincontainer #main_pane_left .group #li_select_theme img,
#maincontainer #main_pane_left .group .ic_b_tblops {
    display: none;
}
...
#maincontainer ul li#li_user_preferences a {
    position:relative;
    top: 6px;
    background-color: #946059;
    padding: 10px 16px;
